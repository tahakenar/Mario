...
// TURTLE DYNAMICS
#define MAXIMUM_TURTLE_COUNT 5
#define SPAWN_TURTLE_DELAY 5 // seconds
#define TURTLE_WIDTH MARIO_WIDTH
#define TURTLE_WALK_SPEED 3
#define TURTLE_JUMP_SPEED -32
#define LOWER_TELEPORT_Y 860
#define UPPER_TELEPORT_Y 200
